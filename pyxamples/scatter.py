...
theta1 = np.linspace(0, 256*np.pi, 10)[1:]
f1 = theta1**(1/2)
x1 = 0.5*f1*np.cos(theta1)
y1 = 0.5*f1*np.sin(theta1)

theta2 = np.linspace(0, 96*np.pi, 10)[1:]
f2 = theta2**(1/2)
x2 = f2*f2*np.cos(theta2)
y2 = f2*f2*np.sin(theta2)

theta3 = np.linspace(0, 32*np.pi, 10)[1:]
f3 = 2*theta3**(1/2)
...
# example is given
plot = scatter(x1, y1, size=12, color="red", alpha=0.5, tools=TOOLS)
